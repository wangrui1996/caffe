...
pretrain_model = "models/oilupload/VGG_ILSVRC_16_layers_fc_reduced.caffemodel"
# Stores LabelMapItem.
...
# conv8_2 ==> 3 x 3
# conv9_2 ==> 1 x 1
mbox_source_layers = ['fc7', 'conv6_2', 'conv7_2', 'conv8_2']
# in percent %
min_ratio = 20
max_ratio = 80
...
steps = [16, 32, 64, 100]
aspect_ratios = [[0.5, 0.2], [0.5, 0.2], [0.5, 0.2], [0.5]]
# L2 normalize conv4_3.
normalizations = [20, 20, 20, 20]
...
PeopleNetBody(net, from_layer='data', fully_conv=True, reduced=True, dilated=True,
    dropout=False)
