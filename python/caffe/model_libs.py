...
# add hopo net
def PeopleNetBody(net, from_layer, need_fc=True, fully_conv=False, reduced=False,
                  dilated=False, nopool=False, dropout=True, freeze_layers=[], dilate_pool4=False):
  kwargs = {
    'param': [dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)],
    'weight_filler': dict(type='xavier'),
  ...
  name = 'pool1'
  net.pool1 = L.Pooling(net.relu1_1, pool=P.Pooling.MAX, kernel_size=2, stride=2)

  net.conv2_1 = L.Convolution(net[name], num_output=128, pad=1, kernel_size=3, **kwargs)
  net.relu2_1 = L.ReLU(net.conv2_1, in_place=True)

  name = 'pool2'
  net[name] = L.Pooling(net.relu2_1, pool=P.Pooling.MAX, kernel_size=2, stride=2)
  net.conv3_1 = L.Convolution(net[name], num_output=256, pad=1, kernel_size=3, **kwargs)
  net.relu3_1 = L.ReLU(net.conv3_1, in_place=True)
  #    net.conv3_2 = L.Convolution(net.relu3_1, num_output=256, pad=1, kernel_size=3, **kwargs)
  #    net.relu3_2 = L.ReLU(net.conv3_2, in_place=True)
  ...
  name = 'pool3'
  net[name] = L.Pooling(net.relu3_1, pool=P.Pooling.MAX, kernel_size=2, stride=2)
  ...
  name = 'pool4'
  net[name] = L.Pooling(net.relu4_1, pool=P.Pooling.MAX, kernel_size=2, stride=2)
  dilation = 1
  ...
  name = 'pool5'
  net[name] = L.Pooling(net.relu5_1, pool=P.Pooling.MAX, pad=1, kernel_size=3, stride=1)
...
def PeopleAttribeNetBody(net, from_layer, num_classes):
  print num_classes
  kwargs = {
    'param': [dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)],
    'weight_filler': dict(type='xavier'),
